...
const ComposeEmail=(props)=>{
    const fromEmail=useSelector(state=>state.userData.email)
    ...
    const sendEmailHandler=async(e)=>{
        ...
        try{
            ...
            const response=await fetch(`https://mailbox-app-1e6f1-default-rtdb.firebaseio.com/${fromEmail}-${toEmail.replace(/[@.]/g,'')}.json`,{
                method:'POST',
